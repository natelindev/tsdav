...
const DAVNamespaceShorthandMap = {
    [exports.DAVNamespace.CALDAV]: 'c',
    [exports.DAVNamespace.CARDDAV]: 'card',
    [exports.DAVNamespace.CALENDAR_SERVER]: 'cs',
    [exports.DAVNamespace.CALDAV_APPLE]: 'ca',
    [exports.DAVNamespace.DAV]: 'd',
};
var ICALObjects;
...
const davRequest = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const xmlBody = convertIncoming
        ? convert__default["default"].js2xml(Object.assign(Object.assign({}, body), { _attributes: attributes }), {
            compact: true,
            spaces: 2,
            elementNameFn: (name) => {
...
const propfind = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return davRequest({
        ...
        init: {
            ...
            namespace: DAVNamespaceShorthandMap[exports.DAVNamespace.DAV],
            body: {
                propfind: {
...
const collectionQuery = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const { url, body, depth, defaultNamespace = exports.DAVNamespace.DAV, headers } = params;
    return davRequest({
        url,
        init: {
            method: 'REPORT',
...
const supportedReportSet = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield propfind({
        url: collection.url,
        props: [{ name: 'supported-report-set', namespace: exports.DAVNamespace.DAV }],
        depth: '1',
        headers,
    });
...
const isCollectionDirty = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const responses = yield propfind({
        url: collection.url,
        props: [{ name: 'getctag', namespace: exports.DAVNamespace.CALENDAR_SERVER }],
        depth: '0',
        headers,
    });
...
const smartCollectionSync = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (syncMethod === 'webdav') {
        const result = yield syncCollection({
            url: collection.url,
            props: [
                { name: 'getetag', namespace: exports.DAVNamespace.DAV },
                {
                    name: account.accountType === 'caldav' ? 'calendar-data' : 'address-data',
                    namespace: account.accountType === 'caldav' ? exports.DAVNamespace.CALDAV : exports.DAVNamespace.CARDDAV,
                },
                {
                    name: 'displayname',
                    namespace: exports.DAVNamespace.DAV,
                },
            ],
            syncLevel: 1,
...
const addressBookQuery = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return collectionQuery({
        ...
        defaultNamespace: exports.DAVNamespace.CARDDAV,
        depth,
        headers,
    });
});
    ...
    return collectionQuery({
        ...
        body: {
            'addressbook-multiget': {
                ...
                [`${DAVNamespaceShorthandMap[exports.DAVNamespace.DAV]}:prop`]: formatProps(props),
                [`${DAVNamespaceShorthandMap[exports.DAVNamespace.DAV]}:href`]: objectUrls,
            },
        },
        defaultNamespace: exports.DAVNamespace.CARDDAV,
        depth,
...
const fetchAddressBooks = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield propfind({
        url: account.homeUrl,
        props: [
            { name: 'displayname', namespace: exports.DAVNamespace.DAV },
            { name: 'getctag', namespace: exports.DAVNamespace.CALENDAR_SERVER },
            { name: 'resourcetype', namespace: exports.DAVNamespace.DAV },
            { name: 'sync-token', namespace: exports.DAVNamespace.DAV },
        ],
        depth: '1',
        headers,
    });
...
const fetchVCards = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (yield addressBookQuery({
        url: addressBook.url,
        props: [{ name: 'getetag', namespace: exports.DAVNamespace.DAV }],
        depth: '1',
        headers,
    ...
    const vCardResults = yield addressBookMultiGet({
        ...
        props: [
            { name: 'getetag', namespace: exports.DAVNamespace.DAV },
            { name: 'address-data', namespace: exports.DAVNamespace.CARDDAV },
        ],
...
const makeCalendar = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return davRequest({
        ...
        init: {
            ...
            namespace: DAVNamespaceShorthandMap[exports.DAVNamespace.DAV],
            body: {
                [`${DAVNamespaceShorthandMap[exports.DAVNamespace.CALDAV]}:mkcalendar`]: {
                    _attributes: getDAVAttribute([exports.DAVNamespace.DAV, exports.DAVNamespace.CALDAV]),
                    set: {
                        prop: formatProps(props),
                    },
...
const fetchCalendars = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield propfind({
        url: account.homeUrl,
        props: [
            { name: 'calendar-description', namespace: exports.DAVNamespace.CALDAV },
            { name: 'calendar-timezone', namespace: exports.DAVNamespace.CALDAV },
            { name: 'displayname', namespace: exports.DAVNamespace.DAV },
            { name: 'getctag', namespace: exports.DAVNamespace.CALENDAR_SERVER },
            { name: 'resourcetype', namespace: exports.DAVNamespace.DAV },
            { name: 'supported-calendar-component-set', namespace: exports.DAVNamespace.CALDAV },
            { name: 'sync-token', namespace: exports.DAVNamespace.DAV },
        ],
        depth: '1',
        headers,
...
const fetchCalendarObjects = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const calendarObjectResults = yield calendarMultiGet({
        ...
        props: [
            { name: 'getetag', namespace: exports.DAVNamespace.DAV },
            { name: 'calendar-data', namespace: exports.DAVNamespace.CALDAV },
        ],
...
const fetchPrincipalUrl = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [response] = yield propfind({
        url: account.rootUrl,
        props: [{ name: 'current-user-principal', namespace: exports.DAVNamespace.DAV }],
        depth: '0',
        headers,
    });
    if (!response.ok) {
    ...
    const responses = yield propfind({
        ...
        props: [
            account.accountType === 'caldav'
                ? { name: 'calendar-home-set', namespace: exports.DAVNamespace.CALDAV }
                : { name: 'addressbook-home-set', namespace: exports.DAVNamespace.CARDDAV },
        ],
        depth: '0',
        headers,
    });
...
exports.DAVNamespaceShorthandMap = DAVNamespaceShorthandMap;
