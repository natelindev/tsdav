...
test('cleanupFalsy should clean undefined from object', () => {
  ...
  expect(Object.hasOwn(cleanupFalsy(objA), 'test1')).toBe(true);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test2')).toBe(true);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test3')).toBe(false);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test4')).toBe(false);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test5')).toBe(false);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test6')).toBe(false);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test7')).toBe(false);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test8')).toBe(true);
  expect(Object.hasOwn(cleanupFalsy(objA), 'test9')).toBe(true);
});
