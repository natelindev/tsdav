...
This file preserves the architecture-oriented notes that previously lived in
the root `AGENTS.md`. The root file is now reserved for day-to-day coding agent
workflow, project guardrails, and verification guidance.
